...
### Changed
- refactor: remove GitHub commands while preserving webhook functionality
- feat: skip telegram platform when broadcasting to all contacts
...
### Added
- feat: Add GitHub webhook POST request support 

### Changed
- fix(deps): update dependency axios to v1.11.0 [security] ([#21](https://github.com/sysfox/koishi-plugin-imx/issues/21))

### Fixed
- fix: 修复 setupCommands 函数中的数据解析问题，确保从 API 返回的数据结构正确


## [2.2.12] - 2025-07-23

### Fixed
- feat: 增强获取统计信息功能，添加详细日志记录和错误处理


## [2.2.11] - 2025-07-23

### Fixed
- fix: 修复请求头中的 Authorization 字段格式
